 ...
 ********************************** OUTPUT ****************************************
    ...
    piradians@3piradians:~/Documents/system_programming/hl2/p05$ ./a.out
    ******* SYSTEM LIMITATIONS ******
    Maximum length of the arguments to the exec family of functions: 2097152
    Maximum number of simultaneous process per user id: 7355
    Maximum number of clock ticks (jiffy) per second: 100
    Maximum number of open files : 1024
    Maximum size of a page in bytes: 4096
    Total number of pages in the physical memory: 500747
    Number of currently available pages in the physical memory.: 59247
