/*
  ************************************************************************
  ...
  Name         : execv.c
  Author       : Pankaj Deopa
  Description  : Program to execute ls -Rl using execv system call.
  Date         : 07 Sept, 2025
 ...
 ******************************************** OUTPUT ****************************************
    ...
    piradians@3piradians:~/Documents/system_programming/solutions/p27$ cc execv.c
    piradians@3piradians:~/Documents/system_programming/solutions/p27$ ./a.out
    Executing ls -Rl using execv.. 
    .:
    total 36
    -rwxrwxr-x 1 piradians piradians 70552 Sep  6 19:03 a.out
